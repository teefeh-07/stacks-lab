...
async function main() {
    ...
    try {
        ...
        await deploy('sip009-nft-trait-v9', 'sip009-nft-trait-v9.clar');
        await new Promise(r => setTimeout(r, 8000));

        await deploy('sip010-ft-trait-v9', 'sip010-ft-trait-v9.clar');
        await new Promise(r => setTimeout(r, 8000));

        // Batch 2: Deploy base contracts
        console.log("\n=== BATCH 2: Deploying Base Contracts ===");
        await deploy('reputation-v9', 'reputation-v9.clar');
        await new Promise(r => setTimeout(r, 8000));

        await deploy('liquidity-locker-v9', 'liquidity-locker-v9.clar');
        await new Promise(r => setTimeout(r, 8000));

        // Batch 3: Deploy NFT contracts
        console.log("\n=== BATCH 3: Deploying NFT Contracts ===");
        await deploy('stacks-hub-avatars-v9', 'stacks-hub-avatars-v9.clar');
        await new Promise(r => setTimeout(r, 8000));

        await deploy('marketplace-v9', 'marketplace-v9.clar');
        await new Promise(r => setTimeout(r, 8000));

        // Batch 4: Deploy main launchpad
        console.log("\n=== BATCH 4: Deploying Launchpad ===");
        await deploy('launchpad-v9', 'launchpad-v9.clar');
        await new Promise(r => setTimeout(r, 8000));

        console.log("\n✅ ALL DEPLOYMENT TRANSACTIONS SENT!");
        console.log("================================================");
        console.log("📝 Deployed Contracts (Clarity 4):");
        console.log(`   1. Launchpad: ${senderAddress}.launchpad-v9`);
        console.log(`   2. Reputation: ${senderAddress}.reputation-v9`);
        console.log(`   3. Liquidity Locker: ${senderAddress}.liquidity-locker-v9`);
        console.log(`   4. Marketplace: ${senderAddress}.marketplace-v9`);
        console.log(`   5. Avatars NFT: ${senderAddress}.stacks-hub-avatars-v9`);
        console.log(`   6. SIP-009 Trait: ${senderAddress}.sip009-nft-trait-v9`);
        console.log(`   7. SIP-010 Trait: ${senderAddress}.sip010-ft-trait-v9`);
        console.log("================================================");
        ...
        console.log(`   Call: ${senderAddress}.reputation-v9.set-authorized`);
        console.log(`   Args: ${senderAddress}.launchpad-v9, true`);
        console.log("================================================");
